  ...
  return (
    <div className={`p-6 rounded-lg transition-transform duration-300 hover:scale-105 ${
      isDefault 
        ...
        : 'border border-gold/30 bg-cream/10 dark:bg-navy-light/20'
    }`}>
      {icon && (
        <div className={`mb-4 ${isDefault ? 'text-gold' : 'text-burgundy dark:text-gold'}`}>
          {icon}
        </div>
      )}
...
// Predefined icons for common features
